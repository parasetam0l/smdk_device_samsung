...
TARGET_BOOTLOADER_BOARD_NAME := smdk7270
TARGET_AP_VER := evt1
...
BOARD_EGL_CFG := device/samsung/smdk7270/conf/egl.cfg
...
# internal isp
#BOARD_BACK_CAMERA_SENSOR := SENSOR_NAME_S5K5E8
#BOARD_FRONT_CAMERA_SENSOR := SENSOR_NAME_S5K5E8
# external isp
BOARD_BACK_CAMERA_SENSOR := SENSOR_NAME_S5K4EC
BOARD_FRONT_CAMERA_SENSOR := SENSOR_NAME_S5K4EC
BOARD_BACK_CAMERA_USES_EXTERNAL_CAMERA := true
BOARD_FRONT_CAMERA_USES_EXTERNAL_CAMERA := true
...
# SELinux Policy DIR
BOARD_SEPOLICY_DIRS = device/samsung/smdk7270/sepolicy
