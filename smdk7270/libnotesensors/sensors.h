...
#define SSP_DEVICE_ENABLE_PATH   "/sys/class/sensors/ssp_sensor/enable"
#define SSP_ACCEL_POLL_DELAY_PATH "/sys/devices/virtual/sensors/ssp_sensor/accel_poll_delay"
